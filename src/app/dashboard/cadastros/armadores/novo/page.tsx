...
export default function NovoArmadorPage() {
  ...
  const pageTitle = isEditing ? 'Editar Armador' : 'Novo Armador';
  const pageDescription = isEditing
    ? 'Altere as informações do armador selecionado.'
    : 'Adicione um novo armador à sua base de dados.';
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
             <div className='flex items-center gap-4'>
                <Link href="/dashboard/cadastros/armadores" passHref>
        ...
        <CardContent>
          <form className="grid gap-6">
            <div className="space-y-2">
                <Label htmlFor="nome-armador">Nome do Armador</Label>
                <Input id="nome-armador" placeholder="Insira o nome do armador" defaultValue={isEditing ? 'MSC' : ''} />
            </div>
            ...
            <div>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="comercial-email" type="email" placeholder="email@armador.com" />
                    </div>
                    <div className="space-y-2">
