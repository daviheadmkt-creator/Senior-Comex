...
export default function NovoProcessoPage() {
 ...
 useEffect(() => {
    if (formData.exportadorId && parceiros) {
        ...
        const newContacts = selectedExporter?.contatos?.filter((c: any) => c.nome).map((c: any, index: number) => ({...c, id: index })) || [];
        setExporterContacts(newContacts);
